...
describe("OrbitActor", () => {
  ...
  it("returns error for unknown message type", async () => {
    ...
    expect(result.error).toContain("Unknown message type: unknown");
    expect(result.details.actorName).toBe("Counter");
    expect(result.details.actorId).toBe("test-id");
    expect(result.details.receivedType).toBe("unknown");
    expect(result.details.knownMessageTypes).toContain("increment");
    expect(result.details.knownMessageTypes).toContain("decrement");
  });
